...
describe('User Schema testing', () => {
    ...
    it('to test the delete user by id', async () => {
            const status = await User.deleteOne({_id :Object('62dc2e54e0449333147692e6')});
  ...
  it('to test the user update', async () => {
        ...
        return User.findOneAndUpdate({_id :Object('62dc2e54e0449333147692e6')}, {$set : {fullname:"Ashok Shrestha"}})
        .then((pp)=>{
